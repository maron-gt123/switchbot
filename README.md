...
*  switch botのAPIを活用した電力/湿度/温度をGrafanaを用いて監視を実施する
  ...
  * Pythonを活用しデータを取得
   ...
   * Python3のコード作成
     ...
     * デバイス情報がPythonでも表示可能か確認[switchbot_湿温度計用.py](https://github.com/maron-gt123/switchbot/blob/main/switchbot-temperature.py)もしくは[switchbot_電気プラグ用.py](https://github.com/maron-gt123/switchbot/blob/main/switchbot_voltage.py)
  * ｄｖｄｓ 
